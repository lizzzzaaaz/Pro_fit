...
import { explosionBarriers } from './explosionBarriersData';
    ...
    <div style={{ backgroundColor: colors.pageBg, padding: '40px 0 80px', fontFamily: fonts.base }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 40px', color: colors.text }}>
        ...
        <div style={{
          ...
          {explosionBarriers.map((barrier) => (
            <button
              key={barrier.page}
              type="button"
              onClick={() => setActivePage(barrier.page)}
              style={{
                textAlign: 'left',
